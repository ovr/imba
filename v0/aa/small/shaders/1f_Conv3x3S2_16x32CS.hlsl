// Specialized Conv3x3: IN_CH=16, OUT_CH=32, stride=2, pad=1
...
void main(uint3 dtid : SV_DispatchThreadID)
{
    ...
    uint inHW  = g_InHeight * g_InWidth;   // input is 2x larger (stride=2)
    ...
    [unroll] for (uint ic = 0; ic < IN_CH; ic++)
    {
        ...
        {
            int iy = (int)(y * 2) + (int)ky - 1;
            int ix = (int)(x * 2) + (int)kx - 1;
